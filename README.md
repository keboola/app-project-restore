# Project Migration - Restore from AWS S3 Snapshot or Microsoft Azure Blob Storage Snapshot
...
- `tableParallelism` _(integer, default 10)_ - Number of tables to restore in parallel.
- `forcePrimaryKeyNotNull` _(boolean, default false)_ - When enabled, nullable primary key columns are forced to NOT NULL during typed table restore instead of failing.
